...
To use these stylesheets, rename the files and drupalcz with the name of your theme.
...
drupalcz-alpha-default-narrow.css  
...
drupalcz-alpha-default-normal.css
...
drupalcz-alpha-default-wide.css
